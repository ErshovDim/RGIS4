...
namespace naloga8
{
    ...
    class Potrosnik
    {
        ...
        public event Obvestilo Akcija1;
        public Potrosnik(string ime, string priimek, string email)
        {
            this.ime = ime;
            this.Priimek = priimek;
            this.email = email;
            Akcija1 = (string param1, string param2) => Console.WriteLine("Sl222222222222222222 " + this.ime + " " + this.Priimek + "(potrosnik)");
            
        }
 
        public void PrijaviSeNaObvestilo(Slikarstvo slik, int dd)
        {
